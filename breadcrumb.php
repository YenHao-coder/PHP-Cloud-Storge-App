...
if(isset($_GET['p_id']) && $_GET['p_id']!= "") {
    ...
    $level1Open = '<li class="breadcrumb-item active" arial-current="page">' . $level1Cname . '</li>';
    ...
    $level2Open = '<li class="breadcrumb-item active" arial-current="page">' . $level2Cname . '</li>';
    //需加處理上一層
