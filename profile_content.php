...
<div class="row" id="modify" name="modify">
    <div class="col-8 offset-2 text-left">
        <form method="GET" name="reg" action="" id="reg">
            <div class="input-group mb-3">
                <input type="email" v-model="member.email" name="email" class="form-control" placeholder="* 請輸入email帳號" readonly>
            </div>
            <div class="input-group mb-3">
                <input type="text" name="cname" v-model="member.cname" id="cname" class="form-control" placeholder="* 請輸入姓名" :readonly="readonly">
            </div>
            <div class="input-group mb-3">
                <input type="text" name="tssn" v-model="member.tssn" id="tssn" class="form-control" placeholder="請輸入身分證字號" :readonly="readonly">
            </div>
            <div class="input-group mb-3">
                <input type="text" name="birthday" id="birthday" v-model="member.birthday" onfocus="(this.type = 'date')" class="form-control" placeholder="* 請選擇生日" :readonly="readonly">
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">會員密碼變更頁面</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form name="changePW" id="changePW">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="PWNew1" name="PWNew1" v-model="PWNew1" placeholder="New Password">
                        </div>
                        <div class="mb-3">
