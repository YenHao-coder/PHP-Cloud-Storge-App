            ...
            <div class="accordion-item mb-3">
                ...
                <div id="collapseOne<?php echo $i; ?>" class="accordion-collapse collapse <?php echo ($i == 21) ? 'show' : ''; ?>" aria-labelledby="headingOne<?php echo $i; ?>" data-bs-parent="#accordion_order">
                    <div class="accordion-body">
                        ...
                        $pTotal = 0;
                        ?>
                        <div class="table-responsive-md" sytle="width:100%;">
                            <table class="table table-hover mt-3">
                                <thead>
                                    <tr  style="background-color:#dee2e6;color:#6c757d;">
                                        <td width="10%">產品編號</td>
                                        <td width="10%">圖片</td>
                                        <td width="30%">名稱</td>
                                        <td width="10%">價格</td>
                                ...
                                <tbody>
                                    <?php while ($cart_data = $cart_rs->fetch()) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <h4 class="color-e600a0 pt-1">$<?php echo $cart_data['p_price']; ?></h4>
                                            </td>
                                            <td><?php echo $cart_data['qty']; ?></td>
                                            <td>
                                                <h4 class="color-e600a0 pt-1">$<?php echo $cart_data['p_price'] * $cart_data['qty']; ?></h4>
                                            </td>
